...
- **Vercel project identity:** `.vercel/project.json` still records `projectId: prj_9myxP5rmQ6QupPjp7vi6dtBF1qug` — **unchanged**. The `prj_sJ6yIgyW59VrOCbTfFbfwO4aJjim` string appearing in commit `2c225f91`'s message refers to a separate Vercel env-var grouping identifier (not the project root), not a project switch.
