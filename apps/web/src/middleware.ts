...
export default auth(async (req) => {
  ...
  // ADR-002 §11.23 → §11.24 (#SEC03 → #P03): the historical /test/*
  // surface was renamed to /_workbench/* in §11.24. Next.js treats
  // `_`-prefixed folders as private (non-routed), so the URL surface
