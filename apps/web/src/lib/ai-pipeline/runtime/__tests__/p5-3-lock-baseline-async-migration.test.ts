...
import { hasUnacknowledgedIncidents, escalateIncident, _resetIncidents } from "../core/incidents/incident-escalation";
import { scanLockResidues } from "../core/persistence/lock-hygiene";
