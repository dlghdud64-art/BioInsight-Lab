...
export const SEVERITY_STYLES = {
  ...
  high: { bg: "bg-yellow-50", border: "border-yellow-200", text: "text-yellow-700", badge: "destructive" as const },
  medium: { bg: "bg-yellow-50", border: "border-yellow-200", text: "text-yellow-700", badge: "outline" as const },
  low: { bg: "bg-pg", border: "border-bd", text: "text-gray-500", badge: "secondary" as const },
} as const;
