        ...
        <div key={i} className="flex items-center gap-1 flex-shrink-0">
          <div className={`flex items-center gap-2 px-3.5 py-2 rounded-lg text-xs font-semibold transition-colors ${
            i < current
              ...
              : "bg-el text-slate-400 border border-bd"
          }`}>
            <span className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold flex-shrink-0 ${
              i < current ? "bg-blue-600 text-white" : i === current ? "bg-pn/25 text-white" : "bg-slate-200 text-slate-400"
            }`}>{i < current ? "✓" : i + 1}</span>
            {label}
          </div>
...
export default function ProtocolBOMPage() {
  ...
  const getCategoryColor = (cat?: string) => {
    if (!cat) return "bg-el text-slate-500";
    ...
    return map[cat] || "bg-el text-slate-500";
  };

  /* ──── 로딩 상태 ──── */
  if (status === "loading") {
    return (
      <div className="min-h-screen bg-pn">
        <MainHeader />
      ...
      <div className="max-w-7xl mx-auto px-4 pt-20 md:pt-24 pb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            ...
            {extractionResult && !bomSaved && (
              <Button
                ...
                className="bg-pn hover:bg-el text-white text-sm flex-shrink-0"
              >
        ...
        {bomSaved && (
          <div className="mb-5 rounded-xl border border-emerald-800 bg-emerald-900/20 px-5 py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            ...
            <div className="flex flex-wrap gap-2">
              <Link href={`/app/search?q=${encodeURIComponent(reagents.slice(0, 3).map(r => r.name).join(" OR "))}`}>
        ...
        <div className="grid gap-4 md:gap-6 lg:grid-cols-[380px,1fr]">
          ...
          <div className="space-y-4">
            <Card className="shadow-none border-bd bg-pn">
                    ...
                    <TabsContent value="upload" className="mt-4 space-y-3">
                      <div
                        ...
                        className={`relative border-2 border-dashed rounded-xl p-6 text-center transition-all ${
                          ...
                          "border-bd bg-pn hover:border-blue-300 hover:bg-blue-950/20/40 cursor-pointer"
                        }`}
                      >
                ...
                <CardContent className="px-4 pb-4 space-y-3">
                  ...
                  <div className="space-y-2 pt-1">
                    {reagents.length > 0 && (
                      <Button
                        onClick={() => {
                          ...
                          router.push(`/app/search?q=${encodeURIComponent(queries.join(" OR "))}`);
                        }}
                    ...
                    <Button
                      ...
                      className="w-full bg-pn hover:bg-el text-white text-sm gap-2"
                    >
          ...
          <div>
            {isAnalyzing ? (
              /* ── 분석 중 스켈레톤 ── */
              <Card className="shadow-none border-bd bg-pn h-full">
                <CardContent className="p-5 space-y-3">
                  ...
                  <div className="space-y-2 animate-pulse">
                    {[1, 2, 3, 4, 5].map((i) => (
                      <div key={i} className="flex items-center gap-3 rounded-lg border border-bd bg-pn p-3">
              ...
              <div className="space-y-4">
                  ...
                  <CardContent className="p-4">
                    <div className="flex flex-wrap items-start gap-3">
                      ...
                      <div className="flex gap-3 flex-shrink-0">
                        ...
                        {estimatedTotal > 0 && (
                          <div className="text-center border-l border-bd pl-3">
                ...
                <Card className="shadow-none border-bd bg-pn">
                  ...
                  <CardContent className="px-0 pb-0">
                          ...
                          {filteredReagents.map((reagent, idx) => {
                            ...
                            return (
                              <React.Fragment key={reagent.id}>
                                <TableRow className={`${reagent.matchedProduct?.isHighRisk ? "bg-red-950/30/30" : ""} hover:bg-pn/60`}>
                    ...
                    {/* 테이블 하단 합계 */}
                    {estimatedTotal > 0 && (
                      <div className="border-t border-bd px-4 py-3 flex items-center justify-between bg-pn">
                ...
                {/* 다음 단계 연결 */}
                <div className="rounded-xl border border-bd bg-pn p-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                  <div>
              ...
              <Card className="shadow-none border-bd bg-pn h-full min-h-[400px] flex flex-col items-center justify-center">
                <CardContent className="py-10 px-6 text-center max-w-md mx-auto">
                  ...
                  <div className="rounded-xl border border-bd bg-pn/70 p-4 text-left space-y-3">
                    ...
                    {[
                      ...
                      <div key={i} className="flex items-start gap-3">
                        <div className="w-7 h-7 rounded-lg bg-pn border border-bd flex items-center justify-center flex-shrink-0 mt-0.5">
      ...
      <Dialog open={isConfirmDialogOpen} onOpenChange={setIsConfirmDialogOpen}>
        <DialogContent className="max-w-sm">
          ...
          <DialogFooter className="gap-2">
            ...
            <Button onClick={() => bomMutation.mutate()} disabled={bomMutation.isPending} className="flex-1 bg-pn hover:bg-el text-white">
