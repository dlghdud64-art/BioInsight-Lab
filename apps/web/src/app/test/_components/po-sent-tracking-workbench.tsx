        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
          ...
          <div>
            ...
            <div className="mt-2 grid grid-cols-2 gap-2">
              <div className="px-3 py-2 rounded-md border border-bd/40 bg-[#252729]"><span className="text-[9px] text-slate-500 block">수신자</span><span className="text-[11px] text-slate-200 font-medium">{trackingState.primaryRecipient}</span></div>
              <div className="px-3 py-2 rounded-md border border-bd/40 bg-[#252729]"><span className="text-[9px] text-slate-500 block">채널</span><span className="text-[11px] text-slate-200 font-medium">{trackingState.sentChannel}</span></div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className={`mt-2 flex items-center gap-3 px-3 py-3 rounded-md border ${trackingState.acknowledgmentStatus === "acknowledgment_received" ? "border-emerald-500/20 bg-emerald-600/[0.03]" : trackingState.acknowledgmentStatus === "no_response" ? "border-slate-700/40 bg-[#252729]" : "border-amber-500/20 bg-amber-600/[0.03]"}`}>
          ...
          {nextStep && (
            <div className="grid grid-cols-2 gap-2">
              <div className={`px-3 py-2.5 rounded-md border ${nextStep.canOpenSupplierConfirmation ? "border-emerald-500/20 bg-emerald-600/[0.03]" : "border-bd/40 bg-[#252729]"}`}>
              ...
              <div className={`px-3 py-2.5 rounded-md border ${nextStep.canOpenReceivingPreparation ? "border-emerald-500/20 bg-emerald-600/[0.03]" : "border-bd/40 bg-[#252729]"}`}>
