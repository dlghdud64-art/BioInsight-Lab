        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
          ...
          <div>
            ...
            <div className="mt-2 grid grid-cols-3 gap-2">
              <div className="px-3 py-2 rounded-md border border-bd/40 bg-[#252729] text-center"><span className="text-[9px] text-slate-500 block">입고 시점</span><span className={`text-[10px] font-medium ${execState.actualRereceiptQtySummary ? "text-slate-200" : "text-slate-600"}`}>{execState.actualRereceiptQtySummary ? "기록됨" : "미기록"}</span></div>
              <div className="px-3 py-2 rounded-md border border-bd/40 bg-[#252729] text-center"><span className="text-[9px] text-slate-500 block">수량</span><span className={`text-[10px] font-medium ${execState.actualRereceiptQtySummary ? "text-slate-200" : "text-slate-600"}`}>{execState.actualRereceiptQtySummary || "미기록"}</span></div>
              <div className="px-3 py-2 rounded-md border border-bd/40 bg-[#252729] text-center"><span className="text-[9px] text-slate-500 block">라인</span><span className="text-[10px] font-medium text-slate-200">{execState.actualReceivedLineCount}/{execState.expectedLineCount}</span></div>
            </div>
          ...
          <div className={`px-3 py-2.5 rounded-md border ${validation?.canOpenInventoryIntakeReentry ? "border-emerald-500/20 bg-emerald-600/[0.03]" : "border-bd/40 bg-[#252729]"}`}>
