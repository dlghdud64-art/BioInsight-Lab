...
export default function SearchPage() {
  ...
  const [workWindowMode, setWorkWindowMode] = useState<"compare" | "request" | "compare-review" | "request-assembly" | "request-submission" | "quote-queue" | "quote-normalization" | "quote-compare" | "po-conversion" | "po-created" | "dispatch-prep" | "send-confirm" | "po-sent-tracking" | "supplier-confirm" | "receiving-prep" | "receiving-exec" | "inventory-intake" | "stock-release" | "reorder-decision" | "procurement-reentry" | "search-reopen" | "result-review" | "compare-reopen" | "request-reopen" | "submission-reopen" | "quote-reentry" | null>(null);
    ...
    <div className="fixed inset-0 z-[60] flex flex-col overflow-hidden" style={{ backgroundColor: '#303236' }}>
      ...
      <QuoteManagementReentryWorkbench
        ...
        onNormalizationReentryHandoff={() => {
          // Normalization Re-entry → Quote Normalization (6단계)로 순환
          setWorkWindowMode("quote-normalization");
        }}
      ...
      {/* ═══ E-25. Center Work Window — Request Review (기존 6-area) ═══ */}
      <RequestReviewWindow
