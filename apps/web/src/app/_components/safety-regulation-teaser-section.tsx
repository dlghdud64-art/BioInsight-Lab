...
export function SafetyRegulationTeaserSection() {
  return (
    <section className="py-8 md:py-10 border-b border-bd">
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        <h2 className="text-base md:text-lg font-semibold tracking-tight text-slate-100 mb-3">
          안전 · 규제 정보
        </h2>

        <Card className="border border-bd bg-pn rounded-lg">
          <CardContent className="p-3">
            <div className="flex items-start gap-2.5">
              <div className="flex-shrink-0">
                <div className="h-7 w-7 flex items-center justify-center rounded-md bg-el">
              ...
              <div className="flex-1 space-y-1.5 min-w-0">
                ...
                <div className="flex gap-2">
                  <Button variant="outline" size="sm" className="text-[10px] md:text-xs h-7 md:h-8 px-2 md:px-3 border-bd flex-shrink-0" disabled>
