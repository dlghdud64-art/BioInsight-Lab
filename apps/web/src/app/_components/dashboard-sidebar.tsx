      ...
      <div className="flex-1 overflow-y-auto p-3 md:p-4 pt-16 lg:pt-8">
        ...
        <div className="space-y-6">
          {sidebarGroups.map((group, groupIndex) => (
            <div key={groupIndex}>
              <h3 className="text-xs font-bold text-gray-400 text-slate-500 uppercase tracking-wider mb-2 px-2 md:px-3 mt-6 first:mt-0">
                {group.label}
              </h3>
              <nav className="space-y-1">
                {group.items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <Icon className={cn("h-5 w-5 flex-shrink-0", isActive ? "text-blue-600 text-blue-400" : isInventory ? "text-blue-500 text-blue-400" : "text-slate-400")} />
                      <span className="truncate whitespace-nowrap">{item.title}</span>
                      {item.badge && (
        ...
        <div className="mt-8 pt-6 border-t border-[#2a2a2e]">
          <p className="mb-2 px-2 md:px-3 text-[10px] font-semibold text-slate-400 text-slate-500 uppercase tracking-wider">
            LabAxis
          </p>
          <nav className="space-y-1">
            {[
