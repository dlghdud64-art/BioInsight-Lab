...
export function PlatformFlowSection() {
  return (
    <section className="py-14 md:py-20 bg-[#111318] border-b border-[#2e3440]">
      <div className="max-w-5xl mx-auto px-4 md:px-6">
        ...
        <div className="hidden md:block">
          <div className="relative">
            {/* Connection line */}
            <div className="absolute top-6 left-6 right-6 h-px bg-[#2e3440]" />
              ...
              {FLOW_STAGES.map((stage, idx) => {
                ...
                return (
                  <div key={stage.title} className="relative flex flex-col items-center text-center px-2">
                    {/* Node */}
                    <div className="relative z-10 w-12 h-12 rounded-md border border-[#363d4a] bg-[#1a1e26] flex items-center justify-center mb-3">
        ...
        {/* Mobile: Dense list */}
        <div className="md:hidden space-y-0 border border-[#2e3440] rounded-md overflow-hidden">
          {FLOW_STAGES.map((stage, idx) => {
            const Icon = stage.icon;
            return (
              <div key={stage.title} className="flex items-center gap-3 px-3 py-2.5 border-b border-[#2e3440] last:border-b-0 bg-[#1a1e26]">
                <div className="flex-shrink-0 w-8 h-8 rounded-md border border-[#363d4a] bg-[#222832] flex items-center justify-center">
        ...
        <div className="mt-10 md:mt-14 border border-[#2e3440] rounded-md bg-[#1a1e26]/50 px-4 py-3">
