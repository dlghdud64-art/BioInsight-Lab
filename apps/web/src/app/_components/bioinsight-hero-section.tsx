...
export function BioInsightHeroSection() {
  ...
  return (
    <section className="relative w-full pt-28 md:pt-36 pb-16 md:pb-20 bg-[#141820] border-b border-[#2e3440]">
      <div className="container px-4 md:px-6 mx-auto relative z-10">
            ...
            {PIPELINE_STEPS.map((step, idx) => {
              ...
              return (
                <div key={step.label} className="flex items-center">
                  <div className="flex flex-col items-center gap-1.5 px-4 py-3 rounded-md hover:bg-[#1a1e26] transition-colors">
        ...
        <div className="max-w-md mx-auto mt-10">
          <form onSubmit={handleSearch} className="flex items-center h-10 border border-[#363d4a] rounded-md bg-[#1a1e26] px-3 focus-within:ring-1 focus-within:ring-slate-500 focus-within:border-slate-400 transition-all">
