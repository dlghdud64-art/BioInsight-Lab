            ...
            {session?.user ? (
              ...
              <div className="flex flex-col flex-1 overflow-y-auto">
                ...
                <nav className="px-4 pb-2">
                  ...
                  <SheetClose asChild>
                    <Link href="/app/search" className="flex items-center gap-2 px-3 py-2.5 text-sm font-medium text-slate-300 hover:bg-st rounded-lg mb-0.5 transition-colors">
              ...
              <div className="flex flex-col flex-1 overflow-y-auto">
                ...
                <nav className="px-4 pt-16 pb-2">
                  ...
                  <SheetClose asChild>
                    <Link href="/search" className="flex items-center gap-2 px-3 py-2.5 text-sm font-medium text-slate-100 hover:bg-st rounded-lg mb-0.5 transition-colors">
                      <Search className="h-4 w-4 text-slate-500" />
                      AI 검색 및 견적
                    </Link>
                  </SheetClose>
