...
export function BioInsightSocialProofSection() {
  return (
    <section className="border-b border-slate-800/60" style={{ backgroundColor: "#0a0e1a" }}>
            ...
            return (
              <div key={metric.label} className="flex items-center justify-center gap-3 py-5 md:py-5 md:px-6">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-slate-600 font-medium mt-0.5 whitespace-nowrap">{metric.sub}</div>
                </div>
              </div>
            );
          })}
