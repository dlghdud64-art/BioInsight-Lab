...
export function FlowSection() {
  return (
    <section id="flow-section" className="mt-12 space-y-3 md:space-y-4 scroll-mt-14">
      <h2 className="text-base md:text-lg font-semibold tracking-tight text-slate-900">
        3단계로 끝나는 구매 준비
      </h2>
      <div className="grid gap-3 md:gap-4 md:grid-cols-3">
        <Link href="/test/search">
          <Card className="h-full border border-slate-200 bg-white shadow-sm rounded-xl hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="flex items-start gap-2.5 md:gap-3 p-3 md:p-4 h-full">
              ...
              {/* 텍스트 블록 */}
              <div className="space-y-1 flex-1 flex flex-col min-w-0">
                <h3 className="text-xs md:text-sm font-semibold text-slate-900">검색</h3>
                <p className="text-[11px] md:text-xs leading-relaxed text-slate-500 flex-1">
        ...
        <Link href="/test/compare">
          <Card className="h-full border border-slate-200 bg-white shadow-sm rounded-xl hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="flex items-start gap-2.5 md:gap-3 p-3 md:p-4 h-full">
              ...
              {/* 텍스트 블록 */}
              <div className="space-y-1 flex-1 flex flex-col min-w-0">
                <h3 className="text-xs md:text-sm font-semibold text-slate-900">비교·선정</h3>
                <p className="text-[11px] md:text-xs leading-relaxed text-slate-500 flex-1">
        ...
        <Link href="/test/quote">
          <Card className="h-full border border-slate-200 bg-white shadow-sm rounded-xl hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="flex items-start gap-2.5 md:gap-3 p-3 md:p-4 h-full">
              ...
              {/* 텍스트 블록 */}
              <div className="space-y-1 flex-1 flex flex-col min-w-0">
                <h3 className="text-xs md:text-sm font-semibold text-slate-900">구매 요청 리스트 정리</h3>
                <p className="text-[11px] md:text-xs leading-relaxed text-slate-500 flex-1">
