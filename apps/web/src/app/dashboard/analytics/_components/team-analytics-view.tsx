  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className={`rounded-xl border p-4 shadow-sm ${riskTeams > 0 ? "border-amber-200/60 bg-amber-50/30 dark:bg-amber-950/10 dark:border-amber-900/30" : "border-slate-200/60 bg-white dark:bg-[#161d2f] dark:border-slate-800/50"}`}>
          <div className="flex items-center gap-2 mb-2">
            ...
            <Table className="min-w-[800px]">
              ...
              <TableBody>
                {TEAM_DATA.map((team) => {
                  ...
                  return (
                    <TableRow key={team.id} className="border-slate-100 dark:border-slate-800/30 hover:bg-slate-50 dark:hover:bg-slate-800/20 transition-colors">
