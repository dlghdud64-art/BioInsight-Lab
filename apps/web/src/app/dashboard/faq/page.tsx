...
const FAQ_ITEMS: FaqItem[] = [
  ...
  // 구매
  {
    ...
    answer: "구매 내역 페이지에서 각 구매 건의 상세 정보를 확인할 수 있습니다. 고액 구매 건은 증빙 업로드 영역이 표시되며, 세금계산서·거래명세서 파일을 직접 첨부하거나 다운로드할 수 있습니다.",
  ...
  },
  {
    ...
    answer: "네, 구매 내역 페이지에서 CSV/엑셀 파일을 업로드하면 시스템이 자동으로 파싱하여 구매 이력에 반영합니다. 업로드 전 미리보기에서 매핑 결과를 확인할 수 있습니다.",
    cta: { label: "구매 내역 보기", href: "/dashboard/purchases" },
  },
  // 재고
  {
    ...
    answer: "구매 내역 페이지에서 입고 반영이 필요한 건을 선택하면 재고 관리 드로어가 '입고 반영' 모드로 열립니다. 실제 입고 수량, Lot 번호, 유효기간을 입력하고 '입고 반영 완료'를 누르면 재고에 자동 반영됩니다.",
  ...
  // 결제/증빙
  {
    ...
    answer: "결제 완료 후 구매 내역 페이지에서 해당 건의 증빙 섹션에서 세금계산서 발행을 요청할 수 있습니다. 사업자등록번호와 담당자 정보를 등록해두면 자동 발행됩니다.",
    cta: { label: "구매 내역 보기", href: "/dashboard/purchases" },
  },
  {
    id: "q10",
