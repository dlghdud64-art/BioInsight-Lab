...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    id: "ai-5",
    category: "ai-pdf",
    question: "재고 운영 도우미(AI 어시스턴트)는 어디서 사용하나요?",
    answer: "재고 관리 페이지 하단의 어시스턴트 버튼을 클릭하면 AI 패널이 열립니다. Lot 추적, 유효기간 만료 예측, 사용량 기반 재주문 시점 추천 등을 제공합니다. 현재 재고 데이터를 자동으로 참조하므로 별도 입력 없이 바로 사용할 수 있습니다.",
    cta: { label: "재고 관리 열기", href: "/dashboard/inventory" },
  },
