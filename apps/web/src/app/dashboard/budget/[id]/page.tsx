...
function BudgetDetailSkeleton() {
  return (
    <div className="min-h-screen bg-[#0b1120] py-8 px-4 md:px-8">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <Card className="shadow-none border-slate-800 bg-slate-900/60">
...
export default function BudgetDetailPage({ params }: { params: { id: string } }) {
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#0b1120]">
        <div className="text-center space-y-4">
          ...
          <Link
            ...
            className="inline-flex items-center text-sm font-medium hover:text-blue-700 text-blue-400 hover:text-blue-300"
          >
  ...
  const budgetStatus = (() => {
    if (usageRate > 100) return { label: "초과", color: "bg-red-900/40 text-red-300 border-red-800" };
    if (usageRate >= 80) return { label: "경고", color: "bg-orange-900/40 text-orange-300 border-orange-800" };
    if (now < periodStart) return { label: "예정", color: "bg-slate-800 text-slate-400 border-slate-800" };
    if (now > periodEnd) return { label: "종료", color: "bg-slate-800 text-slate-500 border-slate-800" };
    return { label: "운영 중", color: "bg-emerald-900/20 text-emerald-300 border-emerald-800" };
  })();
  ...
  return (
    <div className="min-h-screen bg-[#0b1120] py-8 px-4 md:px-8">
      <div className="max-w-6xl mx-auto space-y-6">
          ...
          <CardContent className="p-4 md:p-6">
            <div className="grid grid-cols-3 gap-4 md:gap-6">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xl md:text-2xl font-extrabold tracking-tighter break-keep text-emerald-400">
        ...
        {/* 차트 */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="md:col-span-2 shadow-none border-slate-800 bg-slate-900/60">
        ...
        <DialogContent className="sm:max-w-[500px] bg-slate-900 border-slate-800">
          ...
          {selectedSpending && (
            <div className="space-y-4 mt-2">
              ...
              <div className="rounded-lg border border-slate-700 flex flex-col items-center justify-center py-12 text-center">
