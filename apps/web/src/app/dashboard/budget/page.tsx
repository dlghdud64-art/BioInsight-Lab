            ...
            {Array.from({ length: 3 }).map((_, idx) => (
              <Card key={idx} className="shadow-sm border-[#2a2a2e] animate-pulse">
                ...
                <CardContent className="space-y-4 pt-4">
                  <div className="h-3 rounded bg-[#222226] bg-[#222226]" />
                  <div className="flex justify-end gap-2">
                    <div className="h-8 w-20 rounded bg-[#222226] bg-[#222226]" />
                    <div className="h-8 w-14 rounded bg-[#222226] bg-[#222226]" />
                  </div>
                </CardContent>
              </Card>
            ))}
                    ...
                    <CardHeader className="pb-2">
                      <CardTitle className="text-base sm:text-lg flex justify-between items-center gap-2">
                        ...
                        {(() => {
                          ...
                          if (now < start) return <Badge variant="outline" className="whitespace-nowrap shrink-0 bg-[#222226] text-slate-600 border-[#2a2a2e]">예정</Badge>;
