...
export default function BudgetDetailPage() {
    ...
    return (
      <div className="w-full px-4 md:px-6 py-6">
        <div className="max-w-3xl mx-auto">
          <div className="text-center py-12 text-muted-foreground text-slate-400">
            로딩 중...
          </div>
        </div>
      </div>
  ...
  if (!budget) {
    return (
      <div className="w-full px-4 md:px-6 py-6">
        <div className="max-w-3xl mx-auto">
          <Card className="border-slate-200 border-[#333338]">
  ...
  return (
    <div className="w-full px-4 md:px-6 py-6">
      <div className="max-w-3xl mx-auto space-y-6">
          ...
          <PageHeader
            ...
            description={
              budget.periodStart && budget.periodEnd ? (
                <span className="flex items-center gap-1.5 text-muted-foreground text-slate-400">
        ...
        <Card className="border-slate-200 border-[#333338] bg-[#1a1a1e]/50">
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            {usage && usage.remaining < 0 && (
              <div className="flex items-center gap-2 text-sm text-red-600 text-red-400">
