    ...
    <div className="flex-1 space-y-6 p-4 md:p-6 lg:p-8 pt-6 max-w-7xl mx-auto w-full">
      <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-4 mb-6">
        ...
        <div className="flex gap-2 flex-shrink-0">
          <Button
            className="bg-slate-900 hover:bg-slate-800 text-white bg-slate-800 text-slate-100 hover:bg-slate-200"
      ...
      <div className="border border-slate-700 rounded-lg bg-slate-950 overflow-hidden shadow-none">
            ...
            {auditLogs.map((log) => (
              ...
              >
                ...
                <TableCell>
                  <Badge
                    variant="secondary"
                    className="mb-1 bg-blue-950/40 text-blue-300 hover:bg-blue-950/40"
                  >
                    {log.action}
                  </Badge>
                ...
                <TableCell>
                  {log.before !== "-" ? (
                    <div className="flex items-center gap-2 text-sm flex-wrap">
                      <span className="text-red-400 line-through decoration-red-600">
                        {log.before}
                      </span>
