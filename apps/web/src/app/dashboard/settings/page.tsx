          ...
          <div className="flex-1 min-w-0 space-y-6">
            ...
            {activeSection === "notifications" && (
              <div className="animate-in fade-in-50 duration-300 space-y-5">
                ...
                <div className="bg-[#141820] border border-[#252a32] rounded-xl overflow-hidden">
                  <div className="px-6 py-5 border-b border-[#252a32]">
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          notificationFrequency === "immediate"
                            ...
                            : "border-[#252a32] bg-[#1a1e26] hover:border-[#353a45]"
                        )}
                      >
                        <div className={cn(
                ...
                <div className="bg-[#141820] border border-[#252a32] rounded-xl overflow-hidden">
                                      ...
                                      <SelectTrigger
                                        className={cn(
                                          ...
                                          isOverridden
                                            ...
                                            : "border-[#252a32] bg-[#1a1e26] text-slate-500"
                                        )}
                                      >
                                        <SelectValue />
                                      </SelectTrigger>
                                      <SelectContent className="bg-[#1a1e26] border-[#252a32]">
                  ...
                  {/* Legend */}
                  <div className="px-6 py-3.5 border-t border-[#252a32] bg-[#0e1117]/50">
                    <div className="flex items-center gap-4 text-[11px] text-slate-500">
                      <div className="flex items-center gap-1.5">
                        <div className="h-2 w-2 rounded-full bg-[#252a32]" />
