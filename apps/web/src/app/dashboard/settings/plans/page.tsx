            ...
            <Card className="border-red-200  border-red-800">
              <CardContent className="py-12 text-center space-y-4">
                ...
                {process.env.NODE_ENV === "development" && this.state.error && (
                  <div className="text-left bg-pg bg-el rounded-lg p-3 mt-4">
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20  from-slate-950  via-slate-900  to-slate-950">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto space-y-6">
          <div>
            <div className="h-8 w-48 bg-slate-200 bg-st rounded animate-pulse" />
            <div className="h-4 w-72 bg-slate-200 bg-st rounded animate-pulse mt-2" />
          </div>
          {/* 현재 구독 skeleton */}
          <Card className="bg-pn bg-pn border border-bd shadow-sm">
            <CardHeader className="pb-3">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 bg-slate-200 bg-st rounded-xl animate-pulse" />
                <div className="space-y-2">
                  <div className="h-5 w-32 bg-slate-200 bg-st rounded animate-pulse" />
                  <div className="h-4 w-24 bg-slate-200 bg-st rounded animate-pulse" />
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                {Array.from({ length: 5 }).map((_, i) => (
                  <div key={i} className="rounded-lg bg-pg bg-el/50 p-3">
                    <div className="h-3 w-16 bg-slate-200 bg-st rounded animate-pulse mb-2" />
                    <div className="h-4 w-20 bg-slate-200 bg-st rounded animate-pulse" />
                  </div>
                ))}
              </div>
            </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
            {Array.from({ length: 4 }).map((_, i) => (
              <Card key={i} className="bg-pn bg-pn border border-bd">
                <CardHeader>
                  <div className="h-6 w-24 bg-slate-200 bg-st rounded animate-pulse" />
                  <div className="h-8 w-32 bg-slate-200 bg-st rounded animate-pulse mt-4" />
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    {Array.from({ length: 4 }).map((_, j) => (
                      <div key={j} className="h-4 w-full bg-slate-200 bg-st rounded animate-pulse" />
                    ))}
                  </div>
                </CardContent>
              </Card>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          {organizations.length > 1 && (
            <Card className="bg-pn/80 bg-pn/80 backdrop-blur-sm border border-bd/50 border-bd shadow-sm">
              <CardContent className="pt-6">
                <div className="flex items-center gap-4">
                  ...
                  >
                    <SelectTrigger
                      id="team-select"
                      className="w-[300px] bg-el border-bs"
                    >
          ...
          <Card
            className={cn(
              "bg-pn bg-pn border border-bd shadow-sm relative",
              subFetching && "opacity-60"
            )}
          >
            {/* 조직 전환 중 로딩 오버레이 */}
            {subFetching && (
              <div className="absolute inset-0 flex items-center justify-center bg-pn/50 bg-pn/50 z-10 rounded-lg">
                        ...
                        className={cn(
                          ...
                          currentPlan === SubscriptionPlan.ORGANIZATION
                            ...
                            : currentPlan === SubscriptionPlan.TEAM
                              ...
                              : "bg-el text-slate-600 border-bd bg-el text-slate-400 border-bs"
                        )}
                      >
            ...
            <CardContent>
              ...
              {subError && !subFetching ? (
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                  <div className="rounded-lg bg-pg bg-el/50 p-3">
          ...
          <div className="flex items-center justify-center">
            <div className="bg-pn bg-pn rounded-full p-1 inline-flex border border-bd border-bs shadow-sm">
              <button
                type="button"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5 items-stretch">
            {PLAN_CARDS.map((card) => {
              ...
              return (
                <Card
                  key={card.id}
                  className={cn(
                    "relative flex flex-col transition-all duration-300 hover:shadow-lg bg-pn",
                    isCurrentPlan &&
                ...
                >
                  ...
                  <CardContent className="flex flex-col flex-1 space-y-4">
                    ...
                    <div className="pt-4 mt-auto">
                      {btnInfo.disabled ? (
                        <Button
                          className="w-full bg-el bg-el text-slate-400 hover:bg-el hover:bg-el cursor-not-allowed"
                          disabled
                        >
                          현재 사용 중인 플랜
                        </Button>
            ...
            {/* Enterprise 카드 */}
            <Card className="relative flex flex-col border-bd bg-pn hover:shadow-lg transition-all duration-300">
              <CardHeader className="pb-3 pt-6">
                <div className="flex items-center gap-3 mb-2">
                  <div className="p-2 rounded-lg bg-el bg-el">
          ...
          {/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
              ④ 기능 비교 테이블
             ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */}
          <Card className="bg-pn bg-pn border border-bd shadow-sm overflow-hidden">
            ...
            <CardContent className="p-0">
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    <tr className="border-b border-slate-100 border-bd bg-pg/50 bg-el/30">
                    ...
                    {FEATURE_COMPARISON.map((feat) => {
                      ...
                      return (
                        <tr
                          key={feat.key}
                          className="border-b border-slate-100 border-bd hover:bg-pg/50 hover:bg-el/30 transition-colors"
                        >
          ...
          {/* ── 문의 안내 ── */}
          <Card className="bg-pg bg-pn/50 border border-bd">
