                  ...
                  {isLoading ? (
                    ...
                    <div className="space-y-2 md:space-y-3">
                      {logs.map((log: any) => {
                        ...
                        const colorClass = ACTIVITY_TYPE_COLORS[log.activityType] || "bg-[#222226] text-slate-300 border-[#2a2a2e]";
                        const label = ACTIVITY_TYPE_LABELS[log.activityType] || log.activityType;

                        return (
                          <div
                            key={log.id}
                            className="flex items-start gap-2 md:gap-4 p-2.5 md:p-4 border border-[#2a2a2e] rounded-lg hover:bg-[#222226] transition-colors"
                          >
