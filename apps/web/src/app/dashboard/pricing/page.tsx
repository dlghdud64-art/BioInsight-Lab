  ...
  return (
    <div className="flex-1 space-y-12 p-4 md:p-8 pt-6 max-w-6xl mx-auto w-full">
      ...
      <div className="grid md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
        {/* Starter */}
        <Card className="border-slate-800 flex flex-col">
        ...
        <Card className="border-blue-500 shadow-lg relative flex flex-col transform md:-translate-y-4">
          ...
          <CardHeader className="text-center pb-4 pt-8">
            ...
            <CardTitle className="text-2xl text-blue-100">프로 (Pro)</CardTitle>
        ...
        <Card className="border-slate-800 flex flex-col">
          ...
          <CardFooter>
            <Button variant="outline" className="w-full bg-slate-900/50">
              영업팀과 상담하기
            </Button>
          </CardFooter>
        </Card>
          ...
          <Table>
            <TableHeader className="bg-slate-900/50">
              <TableRow>
                ...
                <TableHead className="text-center bg-blue-950/30 text-blue-300 font-bold">
                  Pro
                </TableHead>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell className="text-center font-bold text-blue-400 bg-blue-950/20">
                  무제한
                </TableCell>
              ...
              <TableRow>
                ...
                <TableCell className="text-center">
                  <Minus className="w-4 h-4 mx-auto text-slate-400" />
                </TableCell>
                <TableCell className="text-center bg-blue-950/20">
                  <Check className="w-4 h-4 mx-auto text-blue-400" />
                </TableCell>
                <TableCell className="text-center">
