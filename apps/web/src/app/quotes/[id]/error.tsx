      ...
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <Card>
          <CardContent className="pt-8 pb-8 text-center space-y-4">
            <div className="mx-auto w-fit rounded-full bg-red-950/30 p-3">
            ...
            {error.digest && (
              <p className="text-[10px] text-slate-400 font-mono bg-slate-900 px-3 py-1.5 rounded inline-block">
                오류 ID: {error.digest}
              </p>
            )}
