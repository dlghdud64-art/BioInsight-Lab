  ...
  return (
    <MainLayout>
      ...
      <div className="w-full">
        ...
        <section className="relative pt-20 pb-4 md:pt-28 md:pb-16 bg-gradient-to-b from-slate-50 via-white to-white overflow-hidden">
          ...
          <div className="relative mx-auto max-w-6xl px-4 md:px-6 flex flex-col md:flex-row md:items-center md:gap-12">
            ...
            <div className="flex-1 min-w-0">
              {/* Eyebrow */}
              <div className="inline-flex items-center gap-2 text-xs font-semibold text-blue-400 bg-blue-950/20 border border-blue-800 rounded-full px-3 py-1.5 mb-5">
              ...
              <h1 className="text-[28px] md:text-5xl font-extrabold tracking-tight text-slate-100 mb-4 leading-snug break-keep">
                <span className="md:hidden">시약·장비 검색부터<br /><span className="text-blue-400">구매 운영</span>까지 한곳에서</span>
                <span className="hidden md:inline">시약·장비 검색부터<br /><span className="text-blue-400">구매 운영</span>까지 한곳에서</span>
              </h1>
              <p className="hidden md:block text-lg text-slate-400 mb-8 leading-relaxed max-w-xl break-keep">
                연구실의 반복 구매와 재고 운영 흐름을 한곳에서 관리하세요.
              </p>
              <p className="md:hidden text-sm text-slate-400 mb-5 leading-relaxed break-keep">
                연구실의 반복 구매와 재고 운영 흐름을 한곳에서 관리하세요.
              </p>
              ...
              <div className="hidden md:flex flex-wrap items-center gap-1.5">
                {[
                  { label: "시약·장비 검색", icon: Search, color: "text-blue-400" },
                  ...
                  <div key={i} className="flex items-center gap-1.5">
                    <div className="flex items-center gap-1.5 text-xs font-medium text-slate-400 bg-slate-900 border border-slate-800 rounded-lg px-3 py-1.5">
            ...
            <div className="hidden md:flex flex-col gap-2 flex-shrink-0 w-[380px]">
              {/* Search bar mockup */}
              <div className="bg-slate-900 rounded-xl border border-slate-800 shadow-none p-3">
                <div className="flex items-center gap-2 bg-slate-900 border border-slate-800 rounded-lg px-3 py-2 mb-3">
                ...
                {[
                  ...
                  <div key={i} className={`flex items-center gap-2.5 px-2 py-2 rounded-lg ${i === 0 ? "bg-blue-950/20/60" : "hover:bg-slate-900"} ${i < 2 ? "mb-1" : ""}`}>
                    <div className="w-7 h-7 rounded-md bg-slate-800 flex-shrink-0 flex items-center justify-center">
                    ...
                    <div className="text-right flex-shrink-0">
                      ...
                      {item.badge && (
                        <span className="text-[9px] font-semibold text-blue-400 bg-blue-950/20 px-1.5 py-0.5 rounded-full">{item.badge}</span>
                      )}
                    </div>
                  </div>
                ))}
                <div className="mt-2 flex gap-2">
                  ...
                  <div className="h-8 px-3 rounded-lg border border-slate-800 flex items-center">
                    <span className="text-[11px] text-slate-400">견적 요청</span>
                  </div>
                </div>
              </div>
        ...
        {/* ══ 제품 한눈 요약 (모바일 전용) ═════════════════════════════════ */}
        <div className="md:hidden py-3 bg-slate-900 border-b border-slate-800 px-4">
          <p className="text-[10px] font-semibold text-blue-400 uppercase tracking-wider mb-2">한눈에 보기</p>
        ...
        {/* ══ 2. 핵심 제품 흐름 (4단계) ═══════════════════════════════════ */}
        <section className="py-10 md:py-16 bg-slate-900 border-b border-slate-800">
          <div className="mx-auto max-w-6xl px-4 md:px-6">
            <div className="mb-5 md:mb-12">
              <p className="text-xs font-semibold text-blue-400 uppercase tracking-wider mb-1 md:mb-2">제품 흐름</p>
              ...
              <p className="hidden md:block text-base text-slate-500 mt-2 max-w-2xl break-keep">
                LabAxis은 시약·장비 구매의 전 과정을 하나의 플랫폼에서 처리합니다.
              </p>
            </div>
            ...
            <div className="md:hidden space-y-1.5">
              {[
                { num: 1, title: "시약·장비 검색", desc: "여러 벤더를 통합 검색, 카테고리·브랜드 필터", dot: "bg-blue-600", bg: "bg-blue-950/20" },
                { num: 2, title: "제품 비교", desc: "가격·납기·순도를 나란히 비교, AI 분석", dot: "bg-violet-600", bg: "bg-violet-900/20" },
                { num: 3, title: "견적 요청", desc: "비교표에서 바로 견적 생성·전달", dot: "bg-teal-600", bg: "bg-teal-900/20" },
                { num: 4, title: "재고·이력 운영", desc: "구매 시 자동 재고 반영, Lot·유효기간 추적", dot: "bg-slate-700", bg: "bg-slate-900" },
              ].map((step) => (
                <div key={step.num} className={`flex items-start gap-2.5 px-3 py-2.5 ${step.bg} rounded-lg border border-slate-800`}>
            ...
            <div className="hidden md:grid md:grid-cols-4 gap-4 md:gap-6">
              ...
              <div className="relative">
                <div className="bg-blue-950/20 border border-blue-800 rounded-xl p-4 md:p-5 h-full">
                  ...
                  {/* Mini UI */}
                  <div className="bg-slate-900 rounded-lg border border-blue-800 p-2.5 mb-3 space-y-1.5">
                    <div className="flex items-center gap-1.5 bg-slate-900 rounded px-2 py-1">
                      <Search className="h-3 w-3 text-slate-300" />
                      <div className="h-2 bg-slate-200 rounded flex-1" />
                    </div>
                    {[{ w: "w-3/4" }, { w: "w-5/6" }, { w: "w-2/3" }].map((bar, i) => (
                      <div key={i} className={`flex items-center gap-2 px-1 py-1 ${i === 0 ? "bg-blue-950/20 rounded" : ""}`}>
                        <div className="w-4 h-4 rounded bg-slate-800 flex-shrink-0" />
              ...
              {/* Step 2: 비교 */}
              <div className="relative">
                <div className="bg-violet-900/20 border border-violet-100 rounded-xl p-4 md:p-5 h-full">
                  <div className="flex items-center gap-2 mb-4">
                  ...
                  <div className="bg-slate-900 rounded-lg border border-violet-100 p-2 mb-3">
                    <div className="grid grid-cols-3 gap-1 text-[9px] text-center mb-1">
                      <div className="text-slate-400 font-semibold">항목</div>
                      <div className="text-violet-400 font-semibold">A사</div>
                    ...
                    {[
                      ...
                      <div key={i} className="grid grid-cols-3 gap-1 text-[9px] text-center py-0.5 border-t border-slate-50">
                        ...
                        <div className={`font-semibold ${row.win ? "text-violet-400" : "text-slate-500"}`}>{row.a}</div>
              ...
              {/* Step 3: 견적 요청 */}
              <div className="relative">
                <div className="bg-teal-900/20 border border-teal-100 rounded-xl p-4 md:p-5 h-full">
                  <div className="flex items-center gap-2 mb-4">
                  ...
                  {/* Mini quote UI */}
                  <div className="bg-slate-900 rounded-lg border border-teal-100 p-2.5 mb-3 space-y-2">
                    {[
              ...
              {/* Step 4: 재고 운영 */}
              <div>
                <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 md:p-5 h-full">
                  <div className="flex items-center gap-2 mb-4">
                  ...
                  {/* Mini inventory UI */}
                  <div className="bg-slate-900 rounded-lg border border-slate-800 p-2.5 mb-3 space-y-1.5">
                    ...
                    {[
                      ...
                      <div key={i} className="flex items-center justify-between text-[10px] px-1 py-1 rounded bg-slate-900">
          ...
          <div className="mx-auto max-w-6xl px-4 md:px-6">
            <div className="mb-8 md:mb-10">
              ...
              <p className="text-sm md:text-base text-slate-500 mt-2 break-keep">
                역할별 업무 문제와 LabAxis이 만드는 변화를 확인하세요.
              </p>
            </div>
            ...
            <div className="md:hidden space-y-2">
              {[
                { role: "R&D 연구자", icon: Zap, color: "text-amber-500", bg: "bg-amber-950/30", benefits: ["통합 검색으로 후보 즉시 확인", "프로토콜 → 시약 자동 추출"], tags: ["검색", "비교"] },
                { role: "QC/QA 매니저", icon: ShieldCheck, color: "text-emerald-500", bg: "bg-emerald-900/20", benefits: ["구매→재고→사용 이력 한 곳 추적", "유효기간 자동 알림"], tags: ["이력", "유통기한"] },
                { role: "구매 담당자", icon: Layers, color: "text-indigo-500", bg: "bg-indigo-900/20", benefits: ["통합 견적 요청, 5분 완료", "구매 이력·응답 통합 관리"], tags: ["견적", "비교"] },
              ].map((p) => (
                <div key={p.role} className="bg-slate-900 border border-slate-800 rounded-lg p-3.5 flex items-start gap-3">
            ...
            <div className="hidden md:grid md:grid-cols-3 md:gap-6">
              ...
              {/* R&D 연구자 */}
              <div className="bg-slate-900 border border-slate-800 shadow-none rounded-xl p-5 md:p-6 flex flex-col gap-4">
                <div className="flex items-start justify-between">
                  <div>
                    <p className="text-xs font-semibold text-amber-400 uppercase tracking-wider mb-1">R&D 연구자</p>
                ...
                <div className="rounded-lg bg-blue-950/20 border border-blue-800 p-3">
                ...
                <div className="flex gap-2 mt-auto">
                  <span className="text-[10px] font-semibold text-slate-500 bg-slate-800 rounded-md px-2 py-1">시약·장비 검색</span>
                  <span className="text-[10px] font-semibold text-slate-500 bg-slate-800 rounded-md px-2 py-1">제품 비교</span>
                </div>
              </div>
              ...
              <div className="bg-slate-900 border border-slate-800 shadow-none rounded-xl p-5 md:p-6 flex flex-col gap-4">
                <div className="flex items-start justify-between">
                  <div>
                    <p className="text-xs font-semibold text-emerald-400 uppercase tracking-wider mb-1">QC/QA 매니저</p>
                ...
                <div className="rounded-lg bg-emerald-900/20 border border-emerald-100 p-3">
                  <p className="text-[10px] font-semibold text-emerald-400 uppercase tracking-wider mb-1.5">LabAxis로 달라지는 것</p>
                  <ul className="space-y-1">
                ...
                <div className="flex gap-2 mt-auto">
                  <span className="text-[10px] font-semibold text-slate-500 bg-slate-800 rounded-md px-2 py-1">재고 이력</span>
                  <span className="text-[10px] font-semibold text-slate-500 bg-slate-800 rounded-md px-2 py-1">유통기한 관리</span>
                </div>
              </div>
              ...
              <div className="bg-slate-900 border border-slate-800 shadow-none rounded-xl p-5 md:p-6 flex flex-col gap-4">
                <div className="flex items-start justify-between">
                  <div>
                    <p className="text-xs font-semibold text-indigo-400 uppercase tracking-wider mb-1">구매 담당자</p>
                    <h3 className="text-base font-bold text-slate-100">견적 수집과 비교 자동화</h3>
                  </div>
                  <div className="w-10 h-10 rounded-xl bg-indigo-900/20 flex items-center justify-center flex-shrink-0">
                ...
                <div className="rounded-lg bg-indigo-900/20 border border-indigo-100 p-3">
                  <p className="text-[10px] font-semibold text-indigo-400 uppercase tracking-wider mb-1.5">LabAxis로 달라지는 것</p>
                  <ul className="space-y-1">
                ...
                <div className="flex gap-2 mt-auto">
                  <span className="text-[10px] font-semibold text-slate-500 bg-slate-800 rounded-md px-2 py-1">견적 요청</span>
                  <span className="text-[10px] font-semibold text-slate-500 bg-slate-800 rounded-md px-2 py-1">가격 비교</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-10 md:py-16 bg-slate-900 border-t border-slate-800">
          <div className="mx-auto max-w-6xl px-4 md:px-6">
              ...
              {[
                {
                  ...
                  badge: "Team / Business",
                  badgeColor: "text-emerald-700 bg-emerald-900/20 border-emerald-800",
                },
                {
                  icon: Lock,
                  ...
                  badge: "전 플랜 기본 제공",
                  badgeColor: "text-blue-700 bg-blue-950/20 border-blue-800",
                },
                {
                  icon: Server,
                  ...
                  badge: "Enterprise",
                  badgeColor: "text-indigo-700 bg-indigo-900/20 border-indigo-800",
                },
              ].map((item, i) => (
                <div key={i} className={`bg-slate-900 rounded-xl border-2 ${item.borderColor} hover:shadow-none transition-shadow p-3 md:p-6`}>
                  ...
                  <div className="hidden md:block">
                    ...
                    <p className="text-xs text-slate-400 leading-relaxed mb-4 break-keep">{item.desc}</p>
            ...
            <div className="bg-slate-900 rounded-xl border border-slate-800 p-4 md:p-6">
              ...
              <div className="mt-5 pt-4 border-t border-slate-800 flex flex-wrap items-center justify-center gap-3">
                <Link href="/pricing">
                  <button className="h-9 px-5 text-sm font-semibold text-blue-400 border border-blue-800 bg-blue-950/20 hover:bg-blue-900/30 rounded-lg transition-colors">
                    요금 & 플랜 보기
                  </button>
                </Link>
                <Link href="/support">
                  <button className="h-9 px-5 text-sm font-medium text-slate-400 border border-slate-800 hover:bg-slate-900 rounded-lg transition-colors">
                    도입 상담 문의
                  </button>
                </Link>
              </div>
