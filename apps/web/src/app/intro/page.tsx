                ...
                <div className="flex flex-col gap-7">
                  ...
                  <div>
                    <div className="flex justify-between mb-2 gap-4">
                      ...
                      <span className="font-bold whitespace-nowrap" style={{ color: CHECK_COLOR }}>한 화면 연결</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-2 gap-4">
                      ...
                      <span className="font-bold whitespace-nowrap" style={{ color: "rgba(141,164,194,0.75)" }}>결정 기록 유지</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-2 gap-4">
                      ...
                      <span className="font-bold whitespace-nowrap" style={{ color: "rgba(141,164,194,0.55)" }}>lot/기한 추적</span>
                    </div>
                    <div className="h-2.5 w-full rounded-full overflow-hidden" style={{ backgroundColor: S.slateCardHigh }}>
                      <div className="h-full rounded-full" style={{ width: "72%", background: "linear-gradient(to right, rgba(141,164,194,0.5), rgba(141,164,194,0.25))" }} />
                    </div>
                  </div>
                </div>
        ...
        <section className="py-28 overflow-hidden" style={{ backgroundColor: S.slatePanel }}>
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              {/* Operation flow card — neutral accent */}
              <div className="rounded-3xl p-7" style={{ backgroundColor: S.slateCard, border: `1px solid ${S.outlineVariant}20`, boxShadow: "0 18px 48px rgba(0,0,0,0.2)" }}>
                <div className="flex items-center justify-between mb-6">
                  <div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                {
                  role: "연구원",
                  roleBg: "rgba(173,198,255,0.12)",
                  roleTextColor: S.primary,
                  accentColor: CHECK_COLOR,
                  accentBg: "rgba(141,164,194,0.04)",
                  cornerBg: "rgba(173,198,255,0.04)",
                  title: "후보 정리가 빨라집니다",
