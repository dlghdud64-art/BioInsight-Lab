...
import {
  ...
  ArrowRight, Shield, ScrollText, Wallet, History,
  BarChart3, Microscope, Users,
} from "lucide-react";
import Link from "next/link";

/* ── Surface colors (M3 inspired) ──────────────────────────────── */
const S = {
  bg: "#0c1324",
  ...
  return (
    <MainLayout>
      ...
      <div className="w-full" style={{ backgroundColor: S.bg, color: S.onSurface }}>
        ...
        {/* ══════════════════════════════════════════════════════════════
            1. Hero — 센터 정렬 + 하단 3-col operating cue 카드 패널
           ══════════════════════════════════════════════════════════════ */}
        <section className="relative min-h-[760px] flex items-center justify-center overflow-hidden px-6">
          {/* Background glow orbs */}
          <div className="absolute inset-0 z-0 pointer-events-none">
            <div className="absolute inset-0" style={{ background: "radial-gradient(circle at center, rgba(39,95,208,0.16) 0%, rgba(12,19,36,0) 68%)" }} />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] rounded-full blur-[140px]" style={{ backgroundColor: "rgba(77,142,255,0.05)" }} />
            <div className="absolute top-24 right-[-120px] w-[360px] h-[360px] rounded-full blur-[110px]" style={{ backgroundColor: "rgba(78,222,163,0.05)" }} />
          </div>
          ...
          <div className="relative z-10 max-w-5xl text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-8 leading-[1.08]" style={{ textShadow: "0 0 18px rgba(173,198,255,0.22)" }}>
              시약·장비 검색부터<br />
            ...
            {/* ── Operating cue 카드 패널 — 3col divider 레이아웃 ── */}
            <div className="max-w-3xl mx-auto rounded-3xl overflow-hidden" style={{ backgroundColor: "rgba(21,27,45,0.82)", backdropFilter: "blur(18px)", border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 24px 80px rgba(12,25,52,0.55)" }}>
              <div className="grid sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
                <div className="px-5 py-4 text-left">
                  <div className="text-[11px] uppercase tracking-[0.18em] mb-2" style={{ color: S.primary }}>운영 cue 01</div>
                  <div className="text-sm font-semibold" style={{ color: S.onSurface }}>검색 → 후보 정리</div>
                  <div className="mt-1 text-xs" style={{ color: S.onSurfaceVariant }}>같은 화면에서 다음 비교 단계로 연결</div>
                </div>
                <div className="px-5 py-4 text-left" style={{ backgroundColor: "rgba(77,142,255,0.04)" }}>
                  <div className="text-[11px] uppercase tracking-[0.18em] mb-2" style={{ color: S.primary }}>운영 cue 02</div>
                  <div className="text-sm font-semibold" style={{ color: S.onSurface }}>비교·선택 → 요청 생성</div>
                  <div className="mt-1 text-xs" style={{ color: S.onSurfaceVariant }}>선택안 기준과 결정 기록을 이어서 유지</div>
                </div>
                <div className="px-5 py-4 text-left">
                  <div className="text-[11px] uppercase tracking-[0.18em] mb-2" style={{ color: S.primary }}>운영 cue 03</div>
                  <div className="text-sm font-semibold" style={{ color: S.onSurface }}>발주 준비 → 입고·재고 연결</div>
                  <div className="mt-1 text-xs" style={{ color: S.onSurfaceVariant }}>운영 상태가 다음 반영 단계로 끊기지 않음</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* ══════════════════════════════════════════════════════════════
           ...
           ══════════════════════════════════════════════════════════════ */}
        <section className="py-24 relative overflow-hidden" style={{ background: "linear-gradient(180deg, rgba(7,13,31,0.98) 0%, rgba(11,22,47,0.96) 100%)" }}>
          <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(circle at top, rgba(77,142,255,0.08), transparent 38%)" }} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                  <div className="p-6 rounded-2xl" style={{ backgroundColor: S.containerHigh, border: `1px solid rgba(77,142,255,0.15)`, boxShadow: "0 22px 60px rgba(0,0,0,0.28)" }}>
                  ...
                  <div className="p-6 rounded-2xl" style={{ backgroundColor: S.containerLow, border: `1px solid ${S.outlineVariant}15` }}>
              ...
              <div className="p-8 md:p-10 rounded-3xl" style={{ backgroundColor: S.containerHigh, border: `1px solid ${S.outlineVariant}20`, boxShadow: "0 22px 60px rgba(0,0,0,0.28)" }}>
                ...
                <div className="flex flex-col gap-7">
                  ...
                  <div>
                    <div className="flex justify-between mb-2 gap-4">
                      <span className="font-medium" style={{ color: S.onSurface }}>비교 → 요청 생성</span>
                      <span className="font-bold whitespace-nowrap" style={{ color: S.primary }}>결정 기록 유지</span>
                    </div>
                    <div className="h-2 w-full rounded-full overflow-hidden" style={{ backgroundColor: S.containerHighest }}>
                      <div className="h-full rounded-full" style={{ width: "79%", backgroundColor: S.primary }} />
                    </div>
                  </div>
                  {/* 3rd — gradient */}
                  <div>
                    <div className="flex justify-between mb-2 gap-4">
                      <span className="font-medium" style={{ color: S.onSurface }}>입고 → 재고 반영</span>
                      <span className="font-bold whitespace-nowrap" style={{ color: S.secondary }}>lot/기한 추적</span>
                    </div>
                    <div className="h-2.5 w-full rounded-full overflow-hidden" style={{ backgroundColor: S.containerHighest }}>
                      <div className="h-full rounded-full" style={{ width: "72%", background: `linear-gradient(to right, ${S.secondary}, ${S.primary})` }} />
                    </div>
                  </div>
                </div>

                <div className="mt-10 rounded-2xl p-4" style={{ backgroundColor: "rgba(77,142,255,0.05)", border: "1px solid rgba(77,142,255,0.15)" }}>
                  <div className="flex items-start gap-3">
                    <BarChart3 className="h-5 w-5 mt-0.5 flex-shrink-0" style={{ color: S.primary }} />
        ...
        {/* ══════════════════════════════════════════════════════════════
            3. 6단계 운영 흐름 — 2컬럼 카드 레이아웃 (Decision / Operation)
           ══════════════════════════════════════════════════════════════ */}
        <section className="py-28 overflow-hidden" style={{ backgroundColor: S.bg }}>
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {/* Decision flow card */}
              <div className="rounded-3xl p-7" style={{ backgroundColor: S.containerLow, border: "1px solid rgba(77,142,255,0.15)", boxShadow: "0 22px 60px rgba(0,0,0,0.28)" }}>
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <div className="text-[11px] uppercase tracking-[0.18em] mb-2" style={{ color: S.primary }}>decision flow</div>
                ...
                <div className="grid sm:grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={step.num} className="rounded-2xl p-5" style={{ backgroundColor: S.containerHigh, border: "1px solid rgba(255,255,255,0.06)" }}>
                      <div className="text-xs mb-3" style={{ color: S.primary }}>{step.num}</div>
                      <step.icon className="h-7 w-7 mb-3" style={{ color: S.primary }} strokeWidth={1.5} />
              ...
              {/* Operation flow card */}
              <div className="rounded-3xl p-7" style={{ backgroundColor: S.containerLow, border: "1px solid rgba(255,255,255,0.10)", boxShadow: "0 22px 60px rgba(0,0,0,0.28)" }}>
                <div className="flex items-center justify-between mb-6">
                  <div>
                ...
                <div className="grid sm:grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={step.num} className="rounded-2xl p-5" style={{ backgroundColor: "#16213a", border: "1px solid rgba(255,255,255,0.06)" }}>
              ...
              {[
                {
                  ...
                  roleTextColor: S.onPrimaryContainer,
                ...
                },
                {
                  ...
                  roleTextColor: S.onSecondaryContainer,
                ...
                },
                {
                  ...
                  roleTextColor: S.onTertiaryContainer,
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between mb-14 gap-8">
              ...
              <Link href="/intro#org-controls">
                <button className="inline-flex items-center gap-2 px-4 py-3 rounded-xl text-sm font-bold transition-all hover:brightness-110 active:scale-95 flex-shrink-0" style={{ backgroundColor: S.containerLow, color: S.primary, border: `1px solid ${S.outlineVariant}20` }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              {/* Row 1: 7 + 5 */}
              <div className="md:col-span-7 rounded-3xl p-8" style={{ backgroundColor: S.containerHigh, border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 22px 60px rgba(0,0,0,0.28)" }}>
                ...
                <div className="flex flex-wrap gap-3 text-xs">
                  <span className="px-3 py-2 rounded-full font-medium" style={{ backgroundColor: "rgba(77,142,255,0.1)", color: S.primary, border: "1px solid rgba(77,142,255,0.15)" }}>승인 기준 유지</span>
                  <span className="px-3 py-2 rounded-full" style={{ backgroundColor: S.containerLow, color: S.onSurfaceVariant, border: "1px solid rgba(255,255,255,0.06)" }}>역할별 권한 매핑</span>
                  <span className="px-3 py-2 rounded-full" style={{ backgroundColor: S.containerLow, color: S.onSurfaceVariant, border: "1px solid rgba(255,255,255,0.06)" }}>발주 전환 전 확인</span>
                </div>
              </div>

              <div className="md:col-span-5 rounded-3xl p-8" style={{ backgroundColor: S.containerLow, border: "1px solid rgba(78,222,163,0.15)", boxShadow: "0 22px 60px rgba(0,0,0,0.28)" }}>
                ...
                <div className="h-1 w-full rounded-full" style={{ background: `linear-gradient(to right, ${S.secondary}, rgba(78,222,163,0.6), transparent)` }} />
              </div>

              {/* Row 2: 4 + 8 */}
              <div className="md:col-span-4 rounded-3xl p-8" style={{ backgroundColor: S.containerLow, border: "1px solid rgba(255,185,95,0.15)", boxShadow: "0 22px 60px rgba(0,0,0,0.28)" }}>
              ...
              <div className="md:col-span-8 rounded-3xl p-8" style={{ backgroundColor: S.containerHigh, border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 22px 60px rgba(0,0,0,0.28)" }}>
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 h-full">
                  ...
                  <div className="flex-1 grid sm:grid-cols-3 gap-3 text-sm">
                    {[
                      ...
                      <div key={m.label} className="rounded-2xl p-4" style={{ backgroundColor: S.containerLow, border: "1px solid rgba(255,255,255,0.06)" }}>
        ...
        {/* ══════════════════════════════════════════════════════════════
            6. Final CTA — 입고 이후 운영 closure 섹션
           ══════════════════════════════════════════════════════════════ */}
        <section className="py-24 relative overflow-hidden">
          <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, rgba(12,22,49,1) 0%, rgba(15,32,66,0.96) 100%)" }} />
          <div className="absolute inset-0" style={{ background: "radial-gradient(circle at center, rgba(77,142,255,0.11), transparent 58%)" }} />
          <div className="relative z-10 max-w-7xl mx-auto px-6">
            <div className="max-w-4xl mx-auto rounded-[2rem] p-10 md:p-14 text-center" style={{ backgroundColor: "rgba(21,27,45,0.75)", backdropFilter: "blur(18px)", border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 24px 80px rgba(12,25,52,0.55)" }}>
              <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold tracking-wide mb-6" style={{ backgroundColor: "rgba(77,142,255,0.1)", color: S.primary }}>
                입고 이후 운영 closure
              </div>
              ...
              <div className="grid sm:grid-cols-3 gap-4 text-left mb-10">
                {[
                  ...
                  <div key={item.num} className="rounded-2xl px-5 py-5" style={{ backgroundColor: S.containerHigh, border: "1px solid rgba(255,255,255,0.06)" }}>
                    <div className="text-xs mb-2" style={{ color: S.primary }}>{item.num}</div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link href="/pricing">
                  <button className="w-full sm:w-auto px-10 py-5 text-lg font-bold rounded-xl shadow-2xl transition-all hover:translate-y-[-2px] active:scale-95" style={{ backgroundColor: S.primary, color: S.onPrimary, boxShadow: "0 12px 40px rgba(77,142,255,0.3)" }}>
                    요금 &amp; 플랜 보기
                  </button>
                </Link>
                <Link href="/support">
