 ...
 *    amber/red/green = warning/critical/success — icon + badge only
 *    Card surfaces are NEVER tinted by signal color
 * ─────────────────────────────────────────────────────────────────────
 */
              ...
              <div className="flex gap-2.5" style={{ width: "max-content" }}>
                {[
                  ...
                  <div key={i} className="snap-start shrink-0 w-[200px] rounded-xl p-4 flex flex-col gap-2" style={{ backgroundColor: "#142840", border: "1px solid #1E3050" }}>
                    ...
                    <p className="text-[11px] leading-relaxed" style={{ color: "#9DADC0" }}>{item.desc}</p>
                  </div>
                ))}
              </div>
            </div>
              ...
              {[
                ...
                <div key={i} className="rounded-xl p-5 flex gap-4" style={{ backgroundColor: "#142840", border: "1px solid #1E3050" }}>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[12px] leading-relaxed break-keep" style={{ color: "#9DADC0" }}>{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
