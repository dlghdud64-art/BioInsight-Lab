  ...
  return (
    <aside className="w-64 bg-[#1a1a1e] border-r border-[#2a2a2e] min-h-screen">
            ...
            <Link
              ...
              className={cn(
                ...
                isActive
                  ...
                  : "text-slate-700 hover:bg-[#222226]"
              )}
            >
      ...
      <div className="absolute bottom-4 left-0 right-0 px-3">
        <Link
          href="/vendor/logout"
          className="flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium text-slate-700 hover:bg-[#222226] transition-colors"
        >
