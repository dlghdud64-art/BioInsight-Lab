  ...
  return (
    <aside className="w-64 bg-slate-900 border-r border-slate-800 min-h-screen">
      ...
      <div className="absolute bottom-4 left-0 right-0 px-3">
        <Link
          href="/vendor/logout"
          className="flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium text-slate-300 hover:bg-slate-800 transition-colors"
        >
