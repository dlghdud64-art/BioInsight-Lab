      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <div className="flex-1 p-5 space-y-4">
          ...
          <div className="bg-pn border border-bd rounded-lg px-4 py-2.5 flex items-center gap-3 flex-wrap">
            ...
            {selectedIds.size > 0 && (
              <div className="flex items-center gap-2 border-l border-bd pl-3">
          ...
          {selectedQuote && (
            <div className="px-5 py-4 space-y-5">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <InfoCell label="상태">
                  <Badge className={cn("text-[10px]", STATUS_CONFIG[selectedQuote.status]?.className || "bg-el text-slate-600")}>
              ...
              <div>
                ...
                {selectedQuote.items && selectedQuote.items.length > 0 ? (
                  ...
                  <div className="text-xs text-slate-400 py-4 text-center border border-dashed border-bd rounded-lg">
                    품목 정보 없음
                  </div>
                )}
              </div>
...
function MiniKPI({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="bg-pn border border-bd rounded-lg p-3 flex items-center gap-3 hover:bg-pg/50 transition-colors text-left"
    >
...
function InfoCell({
  ...
  return (
    <div className="bg-pg rounded-md p-2.5 space-y-0.5">
