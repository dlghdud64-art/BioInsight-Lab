    ...
    <>
      {virtualizer.getVirtualItems().map((virtualRow) => {
        ...
        return (
          ...
          >
                <TableCell className="sticky left-0 bg-pn font-medium w-[100px] sm:w-[120px] md:w-[150px] text-[10px] sm:text-xs md:text-sm text-center sm:text-left px-1 sm:px-2 md:px-4 z-10">
                  {field.label}
                </TableCell>
