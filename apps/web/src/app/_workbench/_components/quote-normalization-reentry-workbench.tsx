        ...
        <div className="px-5 py-3 border-t border-bd bg-[#181E28]">
          ...
          <div className="flex gap-2">
            ...
            {!isRecorded ? (
              ...
              <Button size="sm" className={`flex-1 h-8 text-[10px] font-medium ${validation?.canOpenQuoteCompareReentry ? "bg-emerald-600 hover:bg-emerald-700 text-white" : "bg-slate-700 text-slate-400"}`} onClick={onCompareReentryHandoff} disabled={!validation?.canOpenQuoteCompareReentry}>
