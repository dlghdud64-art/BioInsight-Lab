        ...
        <div className="p-8 md:p-12 print:p-12 space-y-8">
          ...
          <div className="border-b-2 border-gray-800 pb-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-6">
              <div>
                <h1 className="text-3xl font-bold text-slate-900 mb-2">견 적 서</h1>
              ...
              <div className="text-right">
                <div className="text-lg font-bold text-slate-900 mb-2">{company.name}</div>
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-slate-900">견적 품목</h2>
            <div className="border border-bs rounded overflow-hidden">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-el border-b-2 border-bs">
                    <th className="px-4 py-3 text-left text-sm font-bold text-slate-900 border-r border-bs w-12">
                      No.
                    </th>
                    <th className="px-4 py-3 text-left text-sm font-bold text-slate-900 border-r border-bs">
                      품명
                    </th>
                    <th className="px-4 py-3 text-left text-sm font-bold text-slate-900 border-r border-bs w-32">
                      규격
                    </th>
                    <th className="px-4 py-3 text-center text-sm font-bold text-slate-900 border-r border-bs w-20">
                      수량
                    </th>
                    <th className="px-4 py-3 text-right text-sm font-bold text-slate-900 border-r border-bs w-28">
                      단가
                    </th>
                    <th className="px-4 py-3 text-right text-sm font-bold text-slate-900 border-r border-bs w-32">
                      공급가액
                    </th>
                    <th className="px-4 py-3 text-right text-sm font-bold text-slate-900 w-32">
                      세액
                    </th>
                  </tr>
                </thead>
                    ...
                    items.map((item, index) => {
                      ...
                      return (
                        <tr key={item.id} className="border-b border-bd hover:bg-pg">
                          <td className="px-4 py-3 text-sm text-slate-900 border-r border-bd">
                            {lineNumber}
                          </td>
                          <td className="px-4 py-3 text-sm text-slate-900 border-r border-bd">
                          ...
                          <td className="px-4 py-3 text-sm text-slate-900 text-center border-r border-bd">
                            {item.quantity}
                          </td>
                          <td className="px-4 py-3 text-sm text-slate-900 text-right border-r border-bd">
                            {unitPrice > 0 ? `₩${unitPrice.toLocaleString()}` : "-"}
                          </td>
                          <td className="px-4 py-3 text-sm text-slate-900 text-right border-r border-bd font-medium">
          ...
          <div className="flex justify-end">
            <div className="w-full md:w-80 space-y-2">
              <div className="flex justify-between items-center py-2 border-b border-bs">
                <span className="text-sm font-medium text-slate-600">공급가액 합계</span>
                <span className="text-sm font-semibold text-slate-900">
                  ₩{subtotal.toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-bs">
                <span className="text-sm font-medium text-slate-600">부가세 (10%)</span>
                <span className="text-sm font-semibold text-slate-900">
                  ₩{vat.toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between items-center py-3 border-t-2 border-gray-800 mt-2">
                <span className="text-base font-bold text-slate-900">총 견적 금액</span>
