    ...
    <header className="sticky top-0 z-50 h-14 md:h-16 border-b border-transparent backdrop-blur-sm bg-white/97 max-lg:bg-slate-900">
      <div className="flex h-full items-center justify-between gap-2 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4 min-w-0 flex-shrink-0">
          ...
          >
            <span className="text-xl font-bold tracking-tight text-slate-900 max-lg:text-white">LabAxis</span>
          </Link>
        ...
        <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="h-10 w-10 md:hidden flex-shrink-0 p-2 text-white/85 hover:text-white hover:bg-white/10 rounded-md transition-colors"
          ...
          <button
            ...
            className="inline-flex items-center justify-center h-10 w-10 md:h-9 md:w-9 flex-shrink-0 p-2 text-slate-500 hover:text-emerald-600 hover:bg-emerald-50 max-lg:text-white/85 max-lg:hover:text-white max-lg:hover:bg-white/10 rounded-md transition-colors"
          >
          ...
          <div className="relative">
            <button
              ...
              className="inline-flex items-center justify-center h-10 w-10 md:h-9 md:w-9 relative flex-shrink-0 p-2 text-slate-500 hover:text-blue-600 hover:bg-blue-50 max-lg:text-white/85 max-lg:hover:text-white max-lg:hover:bg-white/10 rounded-md transition-colors"
            >
