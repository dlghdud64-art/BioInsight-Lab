...
export function BudgetPredictionWidget({ organizationId }: { organizationId?: string }) {
  ...
  if (isLoadingState) {
    return (
      <Card className="border border-[#2a2a2e] shadow-sm bg-[#1a1a1e] bg-[#1a1a1e] border-[#2a2a2e] animate-pulse">
  ...
  if (!selectedBudget || !selectedBudget.hasBudget) {
    return (
      <Card className="border border-[#2a2a2e] shadow-sm bg-[#1a1a1e] bg-[#1a1a1e] border-[#2a2a2e]">
  ...
  return (
    <Card className={`border border-[#2a2a2e] shadow-sm overflow-hidden border-[#2a2a2e] ${hasWarning ? "bg-red-50/30 bg-red-950/20" : "bg-[#1a1a1e] bg-[#1a1a1e]"}`}>
      <CardContent className="p-0">
          ...
          <div className="flex-1 p-3 sm:p-5 space-y-2 sm:space-y-3">
            ...
            <div className="flex justify-between items-center gap-2">
              ...
              {effectiveBudgets.length > 1 ? (
                ...
                >
                  <SelectTrigger className="h-8 w-[180px] text-xs border-[#2a2a2e] border-[#333338]">
                ...
                <div className="px-2 py-1.5 rounded-full bg-[#111114] bg-[#222226]/60 border border-[#2a2a2e]/80 border-[#333338]/80 text-[11px] text-slate-300">
            ...
            <div className="space-y-1 pt-1">
              ...
              <Progress
                value={usageRate}
                className={`h-2.5 ${usageRate >= 80 ? "[&>div]:bg-red-500 bg-red-950/40" : "bg-[#222226] bg-[#222226]/60"}`}
              />
        ...
        {!selectedBudget.hasWarning && (
          <div className="mx-3 sm:mx-4 rounded-lg bg-[#111114] bg-[#222226]/50 border border-[#2a2a2e] border-[#333338] px-3 py-1.5 sm:px-4 sm:py-2 flex items-start gap-2">
