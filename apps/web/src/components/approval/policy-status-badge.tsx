  ...
  "inline-flex items-center gap-1.5 rounded px-2 py-0.5 text-xs font-medium transition-colors",
  {
    variants: {
      status: {
        ...
        reapproval_needed: "bg-yellow-500/10 text-yellow-400 border border-yellow-500/20",
        escalation_needed: "bg-yellow-500/10 text-yellow-400 border border-yellow-500/20",
