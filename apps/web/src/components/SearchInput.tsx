    ...
    <form onSubmit={onSearch} className="flex gap-2 w-full max-w-xl" role="search" aria-label="제품 검색">
      <div className="relative flex-1">
        ...
        <Input
          ...
          className={`pl-10 md:pl-12 text-sm md:text-base h-10 md:h-11 bg-pg border-bd focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all ${isCasMode ? "border-blue-300 focus:border-blue-500" : ""}`}
          aria-label="검색어 입력"
