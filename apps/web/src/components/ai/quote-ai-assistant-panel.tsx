    ...
    <div className="p-5">
      ...
      <div className="space-y-2">
        {vendors.map((vendor, idx) => (
          <div
            key={idx}
            className="p-3 rounded-lg border border-bd bg-pn/50 hover:border-blue-800 transition-colors"
          >
...
function StickyActions({
  ...
  return (
    <div className="flex-shrink-0 border-t border-bd bg-pn bg-pn px-5 py-3">
