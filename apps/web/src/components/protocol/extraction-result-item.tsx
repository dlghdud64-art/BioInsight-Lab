...
export function ExtractionResultItem({ item }: ExtractionResultItemProps) {
  ...
  return (
    <div className="border border-slate-800 rounded-lg p-4 hover:border-slate-700 hover:shadow-none transition-all bg-slate-900">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs text-slate-400">
            ...
            {item.confidence && (
              <Badge
                ...
                className={`text-xs ${
                  isLowConfidence
                    ? "bg-orange-950/20 text-orange-700 border-orange-800"
          ...
          {item.evidence && (
            <HoverCard>
              <HoverCardTrigger asChild>
                <button 
                  className="text-slate-400 hover:text-blue-400 transition-colors mt-0.5"
                  title="출처 보기"
                >
              ...
              <HoverCardContent className="w-80">
                <div className="space-y-2">
                  ...
                  <div className="text-sm text-slate-300 italic leading-relaxed bg-slate-900 p-3 rounded border-l-2 border-blue-500">
                    "{item.evidence}"
                  </div>
