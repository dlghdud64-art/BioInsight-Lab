...
export function ExtractionResultItem({ item }: ExtractionResultItemProps) {
  ...
  return (
    <div className="border border-bd rounded-lg p-4 hover:border-bs hover:shadow-sm transition-all bg-pn">
            ...
            <HoverCard>
              ...
              <HoverCardContent className="w-80">
                <div className="space-y-2">
                  ...
                  <div className="text-sm text-slate-700 italic leading-relaxed bg-pg p-3 rounded border-l-2 border-blue-500">
                    "{item.evidence}"
                  </div>
                  <div className="text-xs text-slate-500 pt-2 border-t border-bd">
