...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 h-6 font-semibold text-[11px] tracking-wide gap-1.5 w-fit transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-blue-600/15 text-blue-400",
        secondary:
          "border-transparent bg-pn text-slate-300",
        destructive:
          "border-transparent bg-red-600/15 text-red-400",
        outline: "border-bd text-slate-300",
        success:
          "border-transparent bg-emerald-600/15 text-emerald-400",
        warning:
          "border-transparent bg-amber-600/15 text-amber-400",
      },
    },
    defaultVariants: {
      variant: "default",
