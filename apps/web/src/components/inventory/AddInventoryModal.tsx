        ...
        {(inventory || (step === "details" && selectedProduct)) ? (
          <form onSubmit={handleSubmit} className="grid gap-6 py-4">
            ...
            <div className="space-y-4">
              <h4 className="text-sm font-semibold text-blue-600 text-blue-400 border-b border-slate-200 border-[#333338] pb-2">
                기본 식별 정보
              </h4>
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  readOnly
                  className="border-slate-300 border-[#333338] bg-slate-50 bg-[#1a1a1e]/50"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    value={formBrand}
                    readOnly
                    className="bg-slate-50 bg-[#1a1a1e]/50"
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    value={formCatNo}
                    readOnly
                    className="bg-slate-50 bg-[#1a1a1e]/50 font-mono"
            ...
            {/* 2. 수량 및 관리 정보 */}
            <div className="space-y-4">
              <h4 className="text-sm font-semibold text-blue-600 text-blue-400 border-b border-slate-200 border-[#333338] pb-2 mt-2">
                수량 및 관리 정보
              </h4>
