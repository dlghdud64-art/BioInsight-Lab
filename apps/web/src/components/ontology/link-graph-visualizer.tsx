...
const NODE_TYPE_STYLES: Record<OntologyObjectType, { bg: string; border: string; icon: string }> = {
  ...
  Quote:             { bg: "fill-yellow-500/20",    border: "stroke-yellow-500/50",    icon: "📋" },
  QuoteLine:         { bg: "fill-yellow-500/10",    border: "stroke-yellow-500/30",    icon: "📝" },
  ...
  DispatchPackage:   { bg: "fill-sky-500/20",   border: "stroke-sky-500/50",   icon: "📨" },
  ReceivingRecord:   { bg: "fill-teal-500/20",     border: "stroke-teal-500/50",     icon: "✅" },
  QuoteComparison:   { bg: "fill-yellow-500/15",    border: "stroke-yellow-500/40",    icon: "⚖️" },
