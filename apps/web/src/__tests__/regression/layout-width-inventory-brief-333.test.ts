...
describe("§11.333 Part A — 운영 화면 wide 정책 정합", () => {
  ...
  it("inventory-content max-w-full 보존 (이미 wide)", () => {
    // §inventory-dead-file-cleanup(2026-08-06) — inventory-main.tsx 절반은 삭제.
    //   그 파일은 importer 0 dead file 이었고 트랙에서 제거됨. 라이브 절반만 승계.
