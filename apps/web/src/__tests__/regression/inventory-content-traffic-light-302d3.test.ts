...
describe("§11.302d-3 — inventory-content 잔여 yellow 일괄 신호등 정합", () => {
  ...
  describe("d-3b 승인 대기 Badge — inventory-content surface 정리로 제거", () => {
    // 승인 대기 badge(labaxis-inventory-approval-waiting-state)는 inventory-content
    // surface 정리로 제거됨. 저대비 yellow badge 재유입 방지 guard 로 전환.
    it("승인 대기 badge 제거됨(inventory-content 잔존 0)", () => {
