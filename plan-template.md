---
name: plan-template
description: Template for creating structured implementation plans with TDD integration and quality gates
---
...
test("should validate user credentials", () => {
  // Arrange
  const authService = new AuthService(mockDatabase);
...
class AuthService {
  function authenticate(credentials) {
    ...
    const user = database.findUser(credentials.username);
